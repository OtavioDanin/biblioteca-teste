...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h2>Editar Assunto: {{ $assunto['descricao'] }}</h2>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('assuntos.update', $assunto['cod_as']) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="descricao" name="descricao" value="{{ old('descricao', $assunto['descricao']) }}" required maxlength="20">
                </div>
